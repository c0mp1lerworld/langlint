// Package repositories contains the Postgres implementations of the provisioner
// storage ports. Unlike the api repositories they do not join a request-scoped
// transaction: batch jobs encapsulate their own atomicity here in the adapter
// (AP8), never in the services.
